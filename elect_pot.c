...
int Evaluate_Elect_Pot(double z, int nt, double *matp, int *np, int *ang, int *ncm,
              double *expo, char *bound, double *arreglo_factorial,
              double *arreglo_inv_factorial, double *grid, int n_points, double Rc)
{
  int i;
  double r, pot;
  extern double Elect_Pot_RHO(int nt, double *matp, int *np, int *ang, int *ncm,
                double *expo, char *bound, double *arreglo_factorial,
                double *arreglo_inv_factorial, double r, double Rc);

  for (i = 0; i < n_points; i++) {
    r = grid[i];
    pot = Elect_Pot_RHO(nt, matp, np, ang, ncm, expo, bound,
